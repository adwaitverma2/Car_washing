...
export default function Contact() {
  const contactItems = [
    { icon: Mail, label: "Email Us", value: "theharrywheels007@gmail.com", href: "mailto:theharrywheels007@gmail.com" },
    { icon: Phone, label: "Call Us", value: "+91 9235130429", href: "tel:9235130429" },
