        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2">
              <a href="mailto:theharrywheels007@gmail.com" className="flex items-center gap-2 text-sm text-white/60 hover:text-secondary transition-colors">
                <Mail className="w-4 h-4" /> theharrywheels007@gmail.com
              </a>
              <a href="tel:9235130429" className="flex items-center gap-2 text-sm text-white/60 hover:text-secondary transition-colors">
                <Phone className="w-4 h-4" /> +91 9235130429
              </a>
